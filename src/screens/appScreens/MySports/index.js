...
const data = [
    { id: 1, img: Images.BaseBall, title: "Baseball", notifcationFlag: false, fvrtFlag: false, },
    { id: 2, img: Images.BasketBall, title: "Basketball", notifcationFlag: false, fvrtFlag: false },
    { id: 3, img: Images.BaseBall, title: "Boxing", notifcationFlag: false, fvrtFlag: false },
    { id: 4, img: Images.BasketBall, title: "Baseball", notifcationFlag: false, fvrtFlag: false },
    { id: 5, img: Images.BaseBall, title: "Basketball", notifcationFlag: false, fvrtFlag: false },
    { id: 6, img: Images.BasketBall, title: "Basketball", notifcationFlag: false, fvrtFlag: false },
    { id: 7, img: Images.BaseBall, title: "Boxing", notifcationFlag: false, fvrtFlag: false },
    { id: 8, img: Images.BasketBall, title: "Baseball", notifcationFlag: false, fvrtFlag: false },
    { id: 9, img: Images.BaseBall, title: "Basketball", notifcationFlag: false, fvrtFlag: false },
]
    ...
    return (
        <ImageBackground
            ...
            <View style={styles.mangeFvrtContainer}>
                <Text style={styles.mangeFavTxt}>Manage your favorite sports</Text>
            </View>
            {/* main list  */}
            <FlatList
                data={mySportData}
                    ...
                    <View style={styles.listContiner}>
                        <View style={styles.innerContainer}>
                            ...
                            <TouchableOpacity onPress={() => handleReminder(item, index)}>
                                <Image source={Images.Bell} style={[styles.fvrtIcon, { tintColor: item?.notifcationFlag ? "#FF9900" : Colors.white }]} />
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => handleFvrt(item, index)}>
                                <Image source={item?.fvrtFlag ? Images.FilledFvrt : Images.Favorite} style={styles.fvrtIcon} />
                            </TouchableOpacity>
                        </View>
                    </View>
                )} />
            ...
            <CustomModalView
                ...
                headerTxt={"Set Event Reminders"}
                desTxt={"Allow WatchSports to send notifications"}
                blackBtnTxt={"No"}
                otherBtnTxt={"Yes"}
                btn
                rowStyle={true}
            ...
            <CustomModalView
                visible={fvrtModal}
                desTxt={"You’ll need to register to access these features."}
                blackBtnTxt={"No Thanks"}
                otherBtnTxt={"Create Free Account"}
                btn
                rowStyle={false}
