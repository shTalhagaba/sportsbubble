...
<p>
<strong>Purchasing SportsBubble Services or Products</strong></p>
<p>
...
<ul>
  ...
  <li>
    Post, upload or otherwise transmit or link to Content that you do not own or for which you do not hold the rights or have the authorization or permission to disseminate;</li>
  <li>
    ...
    Harass or harm another person;</li>
  <li>
    Exploit or endanger a minor;</li>
  <li>
    Impersonate or attempt to impersonate any person or entity;</li>
  <li>
    Introduce or engage in activity that involves the use of viruses, bots, worms, or any other computer code, files or programs that interrupt, destroy, or limit the functionality of any computer software or hardware or telecommunications equipment, or otherwise permit the unauthorized use of or access to a computer or a computer network;</li>
  <li>
    Attempt to decipher, decompile, disassemble or reverse engineer any of the software comprising the SportsBubble Sites or the SportsBubble Services;</li>
  <li>
    Interfere with, damage, disable, disrupt, impair, create an undue burden on, or gain unauthorized access to the SportsBubble Services, including SportsBubble’s servers, networks or accounts;</li>
  <li>
    Cover, remove, disable, block or obscure advertisements or other portions of the SportsBubble Services;</li>
  <li>
    Delete or revise any information provided by or pertaining to any other user of the SportsBubble Services;</li>
  <li>
    Use technology or any automated system such as scripts, spiders, offline readers or bots in order to collect or disseminate usernames, passwords, email addresses or other data from the SportsBubble Services, or to circumvent or modify any security technology or software that is part of the SportsBubble Services;</li>
  <li>
  ...
  <li>
    Solicit, collect or request any personal information for commercial or unlawful purposes;</li>
  <li>
    Engage in commercial activity (including but not limited to advertisements or solicitations of business; sales; contests; </li>
  <li>sweepstakes; creating, recreating, distributing or advertising an index of any significant portion of the SportsBubble Content; </li>
  <li>or building a business using the SportsBubble Content) without SportsBubble’s express prior written consent;</li>
  <li>
    Advertise or promote other products or services; or</li>
  <li>
    Attempt, facilitate, induce, aid and abet, or encourage others to do any of the foregoing.</li>
</ul>
<p>
...
<p>
In addition, you agree you will not use the SportsBubble Services in any manner inconsistent with any and all Applicable Law.</p>
<p>
...
<p>
<strong>(3) Each of you and SportsBubble also agrees to give up the ability to seek to represent, in a class action or otherwise, anyone but each of you and SportsBubble </strong>(see paragraph 9 below). </p>
<p>
 (4) There is no judge or jury in arbitration, and court review of an arbitration award is limited.  An arbitrator must follow this Arbitration Agreement.  The arbitrator, however, can award on an individual basis the same damages and relief as a court (including injunctive and declaratory relief, or statutory damages); provided that they are recoverable under these Terms of Use. </p>
<p>
(5) These Terms of Use evidence a transaction in interstate commerce, and thus the Federal Arbitration Act, 9 U.S.C. §§ 1-16, governs the interpretation and enforcement of this Arbitration Agreement.  This Arbitration Agreement shall survive termination of the Terms of Use.</p>
<p>
(6) Any arbitration between you and SportsBubble will be conducted by the Judicial Arbitration and Mediation Services, Inc. ("JAMS"), pursuant to the JAMS Streamlined Arbitration Rules & Procedures effective July 1, 2014 (the "JAMS Rules"), as modified by this agreement to arbitrate.  The arbitration shall be conducted by a single, neutral arbitrator, and if you and SportsBubble cannot agree on who that single arbitrator will be, the arbitrator will be appointed pursuant to the JAMS Rules, with the participation and involvement of SportsBubble and you pursuant to JAMS Rule 12.  The JAMS Rules are available on its website at <a href="http://www.jamsadr.com/rules-streamlined-arbitration" title="JAMS Rules" target="_blank">http://www.jamsadr.com/rules-streamlined-arbitration</a> .  The Consumer Arbitration Minimum Standards are available at <a href="https://www.jamsadr.com/consumer-minimum-standards" title="JAMS standards" target="_blank">https://www.jamsadr.com/consumer-minimum-standards</a>. The arbitrator is bound by these Terms of Use.</p>
<p>
(7) If either you or SportsBubble wish to arbitrate a claim, you or SportsBubble must first send by mail to the other a written Notice of Dispute ("Notice") that sets forth the name, address, and contact information of the party giving notice, the specific facts giving rise to the Dispute, the SportsBubble Service to which the Notice relates, and the relief requested.  Your Notice to SportsBubble must be sent by mail to: SportsBubble, Arbitration Notice of Dispute, 3630 High Street # 18941, Oakland, California, 94619.   SportsBubble will send any Notice to you at the contact information we have for you or that you provide.  It is the sender’s responsibility to ensure that the recipient receives the Notice.  During the first 45 days after you or we send a Notice to the other, you and we may try to reach a settlement of the Dispute. </p>
<p>
(8) If you and we do not resolve the Dispute within 45 days, either you or we may initiate arbitration in accordance with the JAMS Rules.  Further instructions on submitting a Demand for Arbitration may be found at<a href="http://www.jamsadr.com/files/Uploads/Documents/JAMS_Arbitration_Demand.pdf" title="JAMS pdf" target="_blank"> http://www.jamsadr.com/files/Uploads/Documents/JAMS_Arbitration_Demand.pdf </a>.  In addition to filing this Demand for Arbitration with JAMS in accordance with its rules and procedures, you must send a copy of this completed Demand for Arbitration to SportsBubble at the address listed above to which you sent your Notice of Dispute. </p>
<p>
(9) You and SportsBubble acknowledge and agree to abide by the following rules for arbitration:
 (a) YOU AND SPORTSBUBBLE MAY BRING CLAIMS AGAINST THE OTHER ONLY IN YOUR OR ITS INDIVIDUAL CAPACITY, AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED CLASS, REPRESENTATIVE OR MULTI-CLAIMANT PROCEEDING, AND THE ARBITRATOR SHALL HAVE NO POWER TO AWARD CLASS-WIDE RELIEF; (b) SportsBubble will pay arbitration costs as required by the JAMS Consumer Arbitration Minimum Standards and consistent with paragraph 6 below; (c) the arbitrator may award any individual relief or individual remedies that are permitted by Applicable Law and these Terms of Use; and (d) each side pays its own attorneys' fees, except as otherwise provided in paragraph 10 below.</p>
<p>
(10) JAMS charges filing and other fees to conduct arbitrations.  Ordinarily, the claimant has to pay the filing fee to initiate arbitration, but if you wish to commence an arbitration against SportsBubble, you and SportsBubble acknowledge and agree to abide by the following:</p>
<p>
If you are seeking to recover less than $10,000 (inclusive of attorneys’ fees), SportsBubble will pay the filing fee on your behalf or reimburse your payment of it.</p>
<p>
If you are seeking to recover $10,000 or more, you will have to pay the filing fee charged by JAMS, but SportsBubble will reimburse the filing fee if you prevail on all claims decided upon by the arbitrator.</p>
<p>
SportsBubble and you agree that, if the claims to be arbitrated total less than $10,000 (inclusive of attorneys’ fees), the claim ordinarily should be decided on written submissions only, without a telephonic or in-person hearing. SportsBubble will not request a hearing for any claims totaling less than $10,000.  This provision shall not be construed by the arbitrator to deprive you of any rights you may have to a telephonic or in-person hearing in your hometown area pursuant to the JAMS Rules.</p>
<p>
SportsBubble and you agree that, if the claims to be arbitrated total $10,000 or more, the arbitration will occur in a manner and place consistent with the JAMS Rules.</p>
<p>
...
<p>
(14) You and SportsBubble agree to maintain the confidential nature of the arbitration proceeding and shall not disclose the fact of the arbitration, any documents exchanged as part of any mediation,  proceedings of the arbitration, the arbitrator’s decision and the existence or amount of any award, except as may be necessary to prepare for or conduct the arbitration (in which case anyone becoming privy to confidential information must undertake to preserve its confidentiality), or except as may be necessary in connection with a court application for a provisional remedy, a judicial challenge to an award or its enforcement, an order confirming the award, or unless otherwise required by law or court order. In keeping with the confidential nature of the arbitration, You and SportsBubble agree that an order confirming award is only necessary if the obligations of the award have not been performed.  Therefore, before taking any steps to confirm the arbitration award, the party seeking confirmation of the award must give the other party notice of its intention to confirm the award.  If the party who would be the respondent in any such confirmation proceeding performs its obligation under the terms of the arbitration award within 15 business days of such notice, the party who gave notice of its intent to confirm the award shall not seek to confirm or otherwise enforce the award.</p>
<p>
(15) With the exception of subpart (a) in paragraph (9) (i.e., the waiver of the ability to proceed on behalf of multiple claimants or a purported class), if any part of this Arbitration Agreement is deemed invalid, unenforceable, or illegal, then the balance of this Arbitration Agreement shall remain in effect and be construed in accordance with its terms as if the invalid, unenforceable, or illegal provision were not contained. If, however, subpart (a) in paragraph (9) is found invalid, unenforceable or illegal, then the entirety of this Arbitration Agreement shall be null and void, but the rest of these Terms, including the provisions governing where actions against SportsBubble must be pursued, the choice of governing law, and our mutual waiver of the right to a trial by jury, will remain in effect and apply to any claim that, for this or any other reason, proceeds in court rather than in arbitration.</p>
<p>
Governing Law</p>
<p>
This Agreement will be governed by, and construed in accordance with, the laws of the State of New York, without regard to its conflict of law provisions.</p>
<p>
...
<p>
You agree that any notices SportsBubble may be required by Applicable Law to send to you will be effective upon SportsBubble’s sending an e-mail message to the e-mail address you have on file with SportsBubble or publishing such notices on the informational page(s) of the SportsBubble Services.</p>
<p>
You agree that no joint venture, partnership, employment, or agency relationship exists between you and SportsBubble as a result of this Agreement or your use of SportsBubble Services. A printed version of this Agreement and of any notice related to it shall be admissible in judicial or administrative proceedings based upon or relating to this Agreement to the same extent as other business documents and records originally generated and maintained in printed form.</p>
<p>
Nothing contained in this Agreement limits SportsBubble’s right to comply with governmental, court and law enforcement requests or requirements relating to your use of SportsBubble Services or information provided to or gathered by us in connection with such use.</p>

<p> I HAVE READ THIS AGREEMENT AND AGREE TO ALL OF THE PROVISIONS CONTAINED ABOVE.</p></span></html>
`
...
This Privacy Policy notice describes how SportsBubble Inc. (“SportsBubble”) collects, uses, and shares Personal Data that you submit to us and that we collect about you in connection to your use of the WatchSports Application and related Services.</p>
<p>


The term “Services” refers to the information provided in the WatchSports Event Guide and the connect-to-watch services, as well as other products, features, tools, or services offered by the WatchSports application and the SportsBubble Platform.</p>
<p>


The term “Platform” refers to, collectively, the WatchSports application and <a href="https://WatchSports.app" title="WatchSports" target="_blank">WatchSports.app</a> website, and other affiliate or related websites (the “Site”), mobile applications, and other places through which sports event information and related content may be accessed, including websites and applications of SportsBubble’s third-party business partners and other websites where users or website operators are permitted to embed or have otherwise licensed Content.</p>
<p>
This Privacy Notice applies to anyone viewing any content on any Platform or otherwise using the Services, whether you (collectively, “you”) are a registered user of the Services, or a visitor who has not registered for the Services. </p>
<p>


<strong>DATA WE COLLECT</strong></p>
<p>
For purposes of this Privacy Notice, “Personal Data” means information relating, linked or reasonably linkable to an identifiable person. As described further below, we may collect certain Personal Data from or about you in connection with your use of the Services, such as your name, home address, phone number, email address, username and password, pronoun you use, and payment data. You are not required to provide all Personal Data identified in this Privacy Notice in order to view Content or use the Services; however, please note that if you do not provide the Personal Data requested, we may be unable to provide some or all of the Services to you. We may collect Personal Data as follows:</p>
<p>


<strong>Account Registration and Purchases </strong></p>
<p>
We collect Personal Data such as your name, zip code, pronoun, email address and password, and payment data, when you create an account and/or purchase a Service, or when you use or interact with the Platform and Services.</p>
<p>


<strong>Cookies and Tracking Technologies </strong></p>
<p>
When you use the Services, we may collect certain Personal Data using cookies and other technologies, such as web beacons, device IDs, geolocation from IP addresses and Apps, HTML5 local storage, Flash cookies, and IP addresses. We specifically use browser cookies for different purposes, including cookies that are strictly necessary for functionality and cookies that are used for personalization, performance/analytics, and advertising. When you interact with the Services, we may also automatically collect certain data about your device, including information about your web browser, IP address, and time zone, as well as device identifiers or other unique identifiers such as advertising identifiers. We may collect information about your activity on the Services including information about the Content you view, page views, ad data, referral URLs, network state, and identifiers associated with browser cookies, and carrier information. Our “Use of Cookies and Similar Technologies” section contains more information and options to control or opt-out of certain data collection or uses.</p>
<p>


<strong>Social Media Networks </strong></p>
<p>
If you choose to sign up, log into, access, or otherwise connect to the Services through a social media or other third-party account, we may collect Personal Data that you have provided to that </p>
<p>

Social Media Network, such as your user ID and/or user name associated with that Social Media Network, and any information or content you have permitted the Social Media Network to share with us, as well as information you have made public in connection with your Social Media Network account. If you want to control or limit sharing data from Social Media Networks, you should adjust the privacy settings on your Social Media Network account.</p>
<p>


<strong>Communications With Us </strong></p>
<p>
We collect Personal Data, such as your name, email address, and other contact information when you communicate with us, including when you email us, submit information through the Site, such as an inquiry to become an advertiser, and when you sign up to receive materials.</p>
<p>
<strong>Third Parties and Publicly-Available Sources </strong></p>
<p>


We may obtain certain data about you from third-party sources, such as business partners through which you may access the Services or data aggregators, as well as publicly-available sources, in order to help us provide and improve the Services and for marketing and advertising. We may combine your Personal Data with data we obtain from our Services, other users, or third parties to enhance your experience and improve the Services.</p>
<p>


<strong>HOW WE USE DATA WE COLLECT AND PROCESS</strong></p>
<p>
We use Personal Data for a variety of different purposes as set out in further detail below. In some cases, we may ask for your consent so that we may process your Personal Data. However, in certain circumstances, applicable data protection laws allow us to process Personal Data without needing to obtain explicit consent. Subject to applicable law, the purposes for which we may use and process Personal Data, and the legal basis for such processing include:</p>
<p>


<strong>Legitimate Interests</strong></p>
<p>
To operate and provide the Services, in addition to performing our contractual obligations to you, for our “legitimate interests” for the purposes of applicable law, except where such interests are overridden by the interests or fundamental rights and freedoms of the data subject which require protection of personal data. Legitimate interests may include:</p>
<ul>
  <li>
    To provide and improve the Services, including for technical support;</li>
  <li>
           To communicate with you regarding the Services and to address and respond to your requests, inquiries, and complaints;</li>
  <li> To protect the confidentiality or security of information; </li>
  <li>
           To develop, provide, and improve the Services and Platform, including to better tailor the features, content, performance, security, and support of our Services and the Platform;</li>
  <li>
           For our direct marketing purposes and to send surveys in connection with the Services;</li>
  <li>
           For fraud, loss, and other crime prevention purposes, to assist in the investigation of suspected illegal or wrongful activity, and to protect and defend our rights and property, or the rights or safety of third parties; </li>
  <li>
           To enforce our Terms of Use, this Privacy Notice, or agreements with you or with third parties; </li>
  <li>
           To comply with laws, regulators, court orders, or other legal obligations, or pursuant to legal process; or</li>
  <li>
           Subject to applicable contractual or legal restrictions, in connection with a contemplated reorganization or an actual reorganization of our organization. </li>
</ul>
<p>


<strong>Contractual Obligations</strong></p>
<p>To perform our contractual obligations to you, including to fulfill your request for Services, to contact you in relation to any issues with the Services, where we need to provide your Personal Data to our service providers in relation to the Services, or to take steps in response to information or inquiries you may submit prior to entering into a contract or agreement with us.  </p>
<p><strong>Legal Obligations </strong></p>
<p>
To comply with laws, regulators, court orders, or other legal obligations, or pursuant to legal process.<br>
To Protect Data Subjects’ Vital Interests<br>
To protect the vital interests of you or of another person.</p>
<p>


<strong>Consent</strong></p>
<p>
By using our Services and accessing our app or site, you consent to the collection and use of your personally identifiable information and non-personal information as described in this privacy policy and we assume we have your express permission and consent to use transfer your personally identifiable information and non-personal information as detailed herein. In some cases where we are not already authorized to process the Personal Data under applicable law, we may ask for your consent to process your Personal Data. Again, if you do not agree with this Privacy Policy or our other Policies for Services or on this app or site, please do not use Services.</p>
<p>


<strong>DATA RETENTION</strong></p>
<p>
We will generally retain your Personal Data for as long as you maintain an account, for as long as is necessary to provide the Services, or for such longer period as may be required or permitted by applicable law. We will also retain your Personal Data as necessary to comply with our legal obligations, resolve disputes, and enforce our agreements. Please note that the personally identifiable information and non-personal information that we maintain will be deleted or anonymized after we determine there is no longer any reason to process your information or otherwise fulfill our contractual obligations to you. Also, if you request us to delete your information, you should realize that deleting personal information may affect our ability to deliver services or may result in deleting your account completely.</p>
<p>


<strong>ANONYMOUS DATA</strong></p>
<p>
We may create de-identified or anonymous data from Personal Data by removing data components (such as your name, email address, or linkable tracking ID) that makes the data personally identifiable to you or through obfuscation or through other means. Our use of de-identified and anonymized data is not subject to this Privacy Notice.</p>
<p>


<strong>HOW WE MAY DISCLOSE DATA</strong></p>
<p>
We may disclose Personal Data as described in this Privacy Notice, including:</p>
<p>


<strong>Affiliates </strong></p>
<p>
We may disclose some or all of your Personal Data to our subsidiaries, joint ventures, and other companies under our common control (collectively, “Affiliates”), for the purposes described in this Privacy Notice. Where we share Personal Data with our Affiliates, we will require our Affiliates to honor this Privacy Notice, the Terms and Conditions, and other notices and policies we provide to you for Services.</p>
<p>


<strong>Service Providers and Business Partners </strong></p>
<p>
We may disclose Personal Data to business partners, distributors, service providers, marketing partners and vendors in order to maintain the Platform and provide, improve and personalize the Services, including to fulfill a request for our Services. We may also share Personal Data for other technical and processing functions, such as sending e-mails on our behalf, fulfilling orders, technical support, or otherwise operating the Services, for analytics, and for marketing and advertising purposes.</p>
<p>


<strong>Advertising and Marketing</strong></p>
<p>
We may share Personal Data with advertising and marketing partners for advertising and marketing purposes on behalf of SportsBubble and on behalf of third parties, such as video content providers, including with third parties involved in interest-based advertising. These third parties may use their own cookies or similar technologies to collect or request information in delivering advertising tailored to your interests. For more information regarding interest-based advertising and your choices, see the “Interest-Based Advertising” section of this Privacy Notice.</p>
<p>


<strong>Pursuant to Legal Process </strong></p>
<p>
We may also disclose Personal Data to comply with applicable laws and regulations, to respond to a subpoena, search warrant, or other lawful request for information we receive, or as otherwise pursuant to legal process. </p>
<p>


<strong>Protection of Rights and Interests</strong></p>
<p>
We may also use and disclose Personal Data to establish or exercise our legal rights, to enforce our Terms of Use, this Privacy Notice or agreements with you or third parties, to assert and defend against legal claims, or if we believe such disclosure is necessary to investigate, prevent or take other action regarding actual or suspected illegal or fraudulent activities or potential threats to the physical safety or well-being of any person. </p>
<p>


<strong>Business Transactions </strong></p>
<p>
...
<p>
The Platform may contain links or otherwise provide access to non-business partner or non-service providers websites, mobile applications, or Internet locations (collectively “Third-Party Sites”). Please note that SportsBubble has no control over and is not responsible for Third-Party Sites, their content, or any goods or services available through the Third-Party Sites. Our Privacy Notice does not apply to Third-Party Sites. We encourage you to read the privacy policies of any Third-Party Site with which you choose to interact.</p>
<p>


<strong>USE OF COOKIES AND SIMILAR TECHNOLOGIES</strong></p>
<p>
SportsBubble uses cookies and similar technologies to improve user experience, for performance and analytics, and to improve our Content and Services. We also use cookies and similar technologies for purposes of marketing and advertising. In those jurisdictions that require it, we allow the data subject to give explicit permission or to deny the use of certain categories of cookies. A “cookie” is a small text file that a web server stores in browser software. A browser sends cookies to a server when the browser makes a connection to the server (for example, when requesting a web page from the same domain that created the cookie). The purpose of cookies is to remember the browser over time and distinguish one browser instance (or user) from all others. Some cookies and other technologies may serve to track Personal Data previously entered by a user. Most browsers allow you to control cookies, including whether or not to accept them, and how to remove them. Cookies can remember login information, preferences, and similar information. Cookies, as well as other tracking technologies, such as HTML5 local storage, and Local Shared Objects (such as “Flash” cookies), and similar mechanisms, may record information such as a unique identifier, information you enter in a form, IP address, and other categories of data. We may also use web beacons or “pixels,” and in certain circumstances may collect IP address, screen resolution and browser software and operating system types, clickstream patterns, dates and times that our Site is accessed, and other categories of data. If you want to block the use and saving of cookies, you should take the necessary steps within your browser’s settings to block all cookies from SportsBubble and its external serving vendors, or use the cookie control system, if available upon first visit. Please note that if you choose to erase or block your cookies, certain parts of the Services may not function correctly. For instance, we may not be able to store your preferences or login information or customize Content and advertising to your viewing habits. For information on how to disable cookies, refer to your browser’s documentation.</p>
<p>


<strong>SOCIAL NETWORK WIDGETS</strong></p>
<p>
...
<strong>INTEREST-BASED ADVERTISING</strong></p>
<p>
We may disclose various types of information for purposes of interest-based advertising, including for third-party interest-based advertising. Interest-based advertising is advertising that is targeted to you based on your web browsing and app usage over time and across websites or applications. Our advertising practices may also include the use of Personal Data to create de-identified audience segments that can be used for targeted marketing and interest-based advertising on the Site as well as third party services and platforms, mobile apps, and/or websites. Prior to use, the segments are de-identified so that they will not identify You personally. You have the option to restrict the use of information for interest-based advertising and to opt-out of receiving interest-based ads. Depending on from where you access the Services, you may also be asked to consent to our use of cookies, including advertising cookies. The opt-outs for interest-based advertising require that strictly necessary cookies are not blocked by the settings in your web browser. You can opt-out of interest-based advertising with participating entities for each region at <strong><a href="https://optout.aboutads.info" title="Ad Choices" target="_blank">Ad Choices</a></strong>. This website also provides detailed information about how interest-based advertising works. Opting out does not mean that you will no longer receive advertising from us, or when you use the Internet. It just means that the data collected from our website will not be used for interest-based advertising and that the advertising you see displayed on websites will not be customized to your interests.</p>
<p>


<strong>DATA SUBJECT RIGHTS</strong></p>
<p>
It is important that you keep your personally identifiable information up to date. We may give you notice of certain changes and updates by sending you a notice, including to the email address you provided us. It is therefore important you acknowledge and agree that it is your responsibility to maintain a valid e-mail address as a user, review this Platform, our Terms of Use and this Privacy Notice periodically and to be aware of any changes, updates, modifications, additions or deletions. Your continued use of the Services and this Platform after such changes will constitute your acknowledgment of the modified Privacy Notice and agreement to abide and be bound by the modified Privacy Notice.</p>
<p>

For your convenience, we have made a list of some of your privacy rights as well as explained them in greater detail below. Your personal data is yours and you have rights over it, including but not limited to:</p>
<ul>
  <li>
    the right to be informed about the collection and use of your personal data;</li>
  <li>
     the right of access to your personal data and any supplementary information;</li>
  <li>
     the right to have any errors in your personal data rectified;</li>
  <li>
     the right to have your personal data erased (“right to be forgotten”);</li>
  <li>
     the right to block or suppress the processing of your personal data;</li>
  <li>
     the right to move, copy or transfer your personal data from one IT environment to another;</li>
  <li>
     the right to withdraw your consent of our processing of your personal and data;</li>
  <li>
     the right to file a complaint with your local supervisory authority;</li>
  <li>
     the right to object to processing of your personal data in certain circumstances; </li>
  <li>
     the right to non-discrimination for the same prices and service as those who have and have not exercised their privacy rights (although, as mentioned above, exercising rights such as the right to be forgotten, may prevent you from using our services and certain aspects of our Site); and,</li>
  <li>
     rights related to automated decision-making (i.e. where no humans are involved) and profiling (i.e. where certain personal data is processed to evaluate an individual).</li>
</ul>
<p>

In greater detail, some of the above rights include:</p>
<p>

<strong>Request Access to, Modification or Rectification, or Deletion</strong></p>
<p>
You have the right to request access to, modification of, or deletion of your Personal Data we maintain. If you are a registered user or subscriber, you can also make changes to your Personal Data by logging into your account and updating your profile.</p>
<p>


<strong>Request Restriction of Processing</strong></p>
<p>
You have the right to request that we restrict processing of your Personal Data in certain circumstances, such as where you believe that the Personal Data we hold about you is inaccurate or our processing is unlawful.</p>
<p>


<strong>Object to Processing</strong></p>
<p>
In certain circumstances, you may have the right to opt out of data processing or request that we stop processing your Personal Data, such as a request to stop sending you direct marketing communications. To opt-out of direct marketing communications, please see the instructions in the “Withdrawing Your Consent” section of this Privacy <strong>Notice.</strong></p>
<p><strong>


Data Portability</strong></p>
<p>
In certain circumstances, you may have the right to receive the Personal Data concerning you that you provided to us or to request that we transmit your Personal Data to another data controller. </p>
<p>


<strong>Lodge a Complaint</strong></p>
<p>
You have the right to lodge a complaint. To exercise your rights, you may contact us as at <a href="mailto:privacy@sportsbubble.io" title="contact us" target="_blank">privacy@sportsbubble.io.</a> As permitted by law, certain data elements may not be subject to access, modification, portability, restriction and/or deletion. Where permissible, we may charge for this service. We will respond to reasonable requests as soon as practicable and as required by law. To protect your privacy and security, we may take steps to verify your identity in order to respond to your request. To manage your data, you can contact us via e-mail with any requests that you may have.</p>
<p>

Data subjects in certain jurisdictions including Nevada and California may have certain rights under applicable data protection laws, including the right to request confirmation from us as to whether or not we are processing your Personal Data.</p>
<p>

To manage your data, you can contact us via e-mail with any requests that you may have. You can request access to all your personally identifiable information and manage your data, including your withdrawal of consent, by sending an e-mail to us at:  <a href="mailto:privacy@sportsbubble.io" title="contact us" target="_blank">privacy@sportsbubble.io</a>. Where we can provide information access and correction, we will do so for free, except where such requests are unreasonably repetitive, would require a disproportionate effort (for example, developing a new system or fundamentally changing an existing practice), risk the privacy of others, or would be extremely impractical (for instance, requests concerning information residing on backup systems). We may not accommodate a request to change information if we believe the change would violate a law or cause the information to be incorrect. Please note that you may only make a California resident CCPA-related data access or data portability disclosure request twice within a 12-month period. If you choose to contact directly by phone, post or email, you will need to provide us with: enough information to identify you; proof of your identity and address; and, a description of what right you want to exercise and the information to which your request relates. Please know that we are not obligated to make a data access or data portability disclosure if we cannot verify that the person making the request is the person about whom we collected information, or is someone authorized to act on such person’s behalf. Also, you should know that any personal information we collect from you to verify your identity in connection with you request will be used solely for the purposes of verification.</p>
<p>

<strong>WITHDRAWING YOUR CONSENT </strong></p>
<p>
In most cases, we need to process certain of your Personal Data in order to fulfill our contractual obligations to you and for our legitimate interests. Where the basis of processing is legitimate interests, you have a right to object to the processing of your Personal Data. Please note that, subject to applicable law, we may continue to process your Personal Data even where you object if there are compelling legitimate grounds for processing that override your interests and rights, or where processing is necessary to establish, exercise, or defend legal claims. Where consent is the basis of processing, you may at any time withdraw the consent you provided for the processing of your Personal Data for the purposes set forth in this Privacy Notice by contacting us at <a href="mailto:privacy@sportsbubble.io" title="contact us" target="_blank">privacy@sportsbubble.io</a> provided that we are not required by applicable law or professional standards to retain such information. If you would like to stop receiving marketing or promotional messages, notifications, or updates from us, you may do so by following the unsubscribe instructions that appear in e-mail communications. Please be advised that you may not be able to opt-out of receiving certain service or transactional messages from us, including legal notices and certain communications related to the provision of the Services. Please note that if you withdraw your consent or object to processing, or if you choose not to provide certain Personal Data, we may be unable to provide you some or all of the Services.</p>
<p>


<strong>SECURITY</strong></p>
<p>
We implement technical and organizational security measures designed to secure and protect Personal Data. Please note, however, we cannot fully eliminate security risks associated with the storage and transmission of Personal Data.</p>
<p>


<strong>INFORMATION FROM CHILDREN UNDER 18 YEARS OF AGE </strong></p>
<p>
We do not knowingly collect or store information from individuals under the age of 18 years without parental consent. If you become aware that an individual under 13 years of age has provided us with Personal Data without parental consent, please contact us at <a href="mailto:privacy@sportsbubble.io" title="contact us" target="_blank">privacy@sportsbubble.io</a>. If we become aware that an individual under 13 years has provided us with Personal Data without parental consent, we will take steps to remove the data as permitted by law. </p>
<p>


<strong>DO-NOT-TRACK</strong></p>
<p>
Do-Not-Track is a public-private initiative that has developed a “flag” or signal that an Internet user may activate in the user’s browser software to notify websites that the user does not wish to be “tracked” by third-parties as defined by the initiative. Do-Not-Track is not yet standardized and therefore SportsBubble does not alter its behavior or use practices when we receive a Do Not Track signal from your browser.</p>
<p>


<strong>UPDATES TO THIS PRIVACY NOTICE</strong></p>
<p>
We may update this Privacy Notice from time to time. The most recent version of the Privacy Notice is reflected by the version date located at the top of this Privacy Notice. We encourage you to review this Privacy Notice often to stay informed of how we may process your information. Your continued use of the Services and this Platform after such changes will constitute your acknowledgment of the modified Privacy Notice and agreement to abide and be bound by the modified Privacy Notice.</p>
<p>


<strong>CONTACT US</strong></p>
<p>
  For more information about our privacy practices, if you have questions or if you would like to make a complaint, please contact us by e-mail at <a href="mailto:privacy@sportsbubble.io" title="Contact Us" target="_blank">privacy@sportsbubble.io</a></p></span>
</html>
`
...
export const privacyPolicyCA = `
    ...
    The categories of Personal Information that we may collect, disclose, and/or "sell" are below, along with the categories of third parties to whom each category of Personal Information may be disclosed, and/or "sold."  Please note that we may disclose some categories of Personal Information in connection with certain types of advertisements, which could be considered a "sale" under the CCPA.  Also, depending on the California resident’s interactions with us, SportsBubble may not collect, disclose, or "sell" each of these categories about each individual.  Additionally, we will not knowingly "sell" Personal Information of minors under 16 years of age.</p><p>
    We may collect, disclose, and/or "sell" to third parties the following categories of Personal Information: </p><p>
    <strong>A.  Identifiers, </strong>such as name, IP address, email address, and online and device identifiers</p><p>
    Categories of third parties to whom identifiers may be “Disclosed”:</p><p>
    Service providers, SportsBubble Affiliates, and other providers or partners that support our operational business purposes</p><p>
    Categories of third parties to whom identifiers may be "Sold":</p><p>
    Advertising technology companies; advertisers </p><p>
    <strong>B.  Personal information,</strong> as defined in the California Customer Records law, such as contact and financial information</p><p>
    Categories of third parties to whom personal information may be “Disclosed”:</p><p>
    Service providers, SportsBubble Affiliates, and other providers or partners that support our operational business purposes</p><p>
    Categories of third parties to whom personal information may be "Sold":</p><p>
    Advertising technology companies; advertisers </p><p>

    <strong>C.  Characteristics of protected classifications under California law</strong>, such as age or gender</p><p>
    Categories of third parties to whom characteristics of protected classifications under California law may be “Disclosed: </p><p>
    Service providers, SportsBubble Affiliates, and other providers or partners that support our operational business purposes</p><p>
    Categories of third parties to whom characteristics of protected classifications under California law may be "Sold":</p><p>
    Advertising technology companies; advertisers</p><p>
    <strong>D.  Commercial information,</strong> such as transaction information and purchase history</p><p>
    Categories of third parties to whom commercial information may be “Disclosed”: </p><p>
    Service providers, SportsBubble Affiliates, and other providers or partners that support operational business purposes </p><p>
    <strong>E.  Internet or network activity information</strong>, such as browsing history and interactions with our websites, mobile, or connected TV applications (collectively, "SportsBubble Digital Properties")</p><p>
    Categories of third parties to whom internet or network activity information may be “Disclosed”: </p><p>
    Service providers, SportsBubble Affiliates, and other providers or partners that support operational business purposes</p><p>
    Categories of third parties to whom internet or network activity information may be "Sold":</p><p>
    Advertising technology companies; advertisers </p><p>

    <strong>F.  Geolocation data,</strong> such as device location</p><p>
    Categories of third parties to whom geolocation data may be “Disclosed”: </p><p>
    Service providers, SportsBubble Affiliates, and other providers or partners that support operational business purposes</p><p>
    Categories of third parties to whom internet or network activity information may be "Sold":</p><p>
    Advertising technology companies; advertisers </p><p>


    <strong>G.  Inferences drawn from any of the Personal Information</strong> listed above to create a profile or summary about, for example, an individual’s preferences and characteristics.</p><p>
    Categories of third parties to whom inferences drawn from any of the personal information may be “Disclosed”: </p><p>
    Service providers, SportsBubble Affiliates, and other providers or partners that support our operational business purposes</p><p>
    Categories of third parties to whom inferences drawn from any of the personal information that may be "Sold":</p><p>
     Advertising technology companies; advertisers </p><p>

    Please note that the CCPA definition of "sale" does not include, for example, the transfer of Personal Information as an asset that is part of a merger, bankruptcy, or other similar transaction involving all or any portion of our business.</p><p>
    <strong>Sources of Personal Information.</strong> We collect this Personal Information directly from California residents themselves, as well as from social media platforms (e.g., if the individual has connected a social media account to a SportsBubble Digital Property); joint marketing, co-branding, co-promotional, or advertising partners, including advertising technology companies and advertisers; SportsBubble Affiliates; and sources of demographic and other information.  Depending on the individual’s interactions with us, SportsBubble may not have collected Personal Information from each of these categories of sources.</p><p>
    <strong>Purposes.</strong> We may use this Personal Information for the following purposes:</p>
    <ul>
      <li>
        to operate, manage, and maintain our business;</li>
      <li>
        to provide our products and services;</li>
      <li>
        to accomplish our business purposes and objectives, including:</li>
      <li>
        developing, improving, repairing, and maintaining our products and services;</li>
      <li>
        personalizing, advertising, and marketing our products and services;</li>
      <li>
        conducting research, analytics, and data analysis;</li>
      <li>
        maintaining our facilities and infrastructure;</li>
      <li>
        quality and safety assurance measures;</li>
      <li>
        conducting risk and security controls and monitoring;</li>
      <li>
        detecting and preventing fraud;</li>
      <li>
        performing identity verification;</li>
      <li>
        performing accounting, audit, and other internal functions;</li>
      <li>
        complying with law, legal process, and internal policies;</li>
      <li>
        maintaining records; and</li>
      <li>
        exercising and defending legal claims.</li>
    </ul>
    <p>
    Depending on the California resident’s interactions with us, SportsBubble may not have used Personal Information collected about that resident for each of these purposes.</p><p>
    <strong>California Rights.</strong> If you are a California consumer, you have the following rights:</p><p>
    <strong>(1) Right to Know. </strong>You have the right to request that we disclose to you the following information:</p>
    <ul>
      <li>
        The categories of Personal Information we collected about you and the categories of sources from which we collected such Personal Information during the 12 months prior to your request;</li>
      <li>
        The specific pieces of Personal Information we collected about you during that time period;</li>
      <li>
        The business or commercial purpose for collecting, disclosing, or selling Personal Information about you;</li>
      <li>
        The categories of Personal Information about you that we sold and the categories of third parties to whom we sold that Personal Information; and</li>
      <li>
        The categories of Personal Information about you that we otherwise shared or disclosed and the categories of third parties with whom we shared or disclosed that Personal Information.</li>
    </ul>
    <p>
    <strong>(2) Right to Delete: </strong>You have the right to request that we delete the Personal Information that we have collected from you.  Under the CCPA, the right is subject to certain exceptions: for example, we may need to retain your Personal Information to provide you with the Services or complete a transactions or other action you have requested, or to comply with our legal obligations.  If your deletion request is subject to one of these exceptions, we may deny your deletion request. </p><p>
    To exercise your rights, you must send us a request that provides sufficient information to allow us to verify that you are the person about whom we have collected Personal Information and describe your request in sufficient detail to allow us to understand and, evaluate and respond to it.  Each request that meets both of these criteria will be considered a “Valid Request.”  We may not respond to requests that do not meet these criteria, and will only use Personal Information provided in a Valid Request to verify you and complete your request.  </p><p>
    You may submit a Valid Request to the email address:  privacy@sportsbubble.io </p><p>
    <strong>(3)  Right to be Free from Discrimination.</strong> You have the right to be free from unlawful discrimination for exercising your rights under the CCPA.</p><p>

      <strong>CALIFORNIA PRIVACY RIGHTS</strong></p><p>
    Under Section 1798.83 of the California Civil Code, residents of California have the right to request from a business, with whom the California resident has an established business relationship, certain information with respect to the types of personal information (as defined by California law) the business shares with third parties for those third parties’ direct marketing purposes, and the identities of the third parties with whom the business has shared such information during the immediately preceding calendar year. To exercise your rights, you may make one request each year by emailing us at <a href="mailto:privacy@sportsbubble.io" title="Contact us" target="_blank">privacy@sportsbubble.io</a> with “Request for California Privacy Information” in the subject line and in the body of your message. Be sure to provide in the request sufficient information to properly identify you and/or the members of your family. </p>
    </span>
    </html>
`
