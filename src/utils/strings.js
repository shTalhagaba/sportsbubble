export default {
  ...
  addedToFav: 'Added to Favorites successfully! ',
  removeFromFav: 'Removed from Favorites successfully!',
  notificationActive: 'Notification is Active',
  notificationInactive: 'Notification is Inactive',
  changesNotSaved: 'Changes not saved',
  leaveChanges: 'Do you want to leave changes?',
  profileUpdated: 'Profile updated successfully!!',
  passwordChanged: 'Password changed successfully.',
  enterValidPassword: 'Please enter valid current password',
