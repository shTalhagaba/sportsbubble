...
const styles = ScaledSheet.create({
  headerContainer: {
    height: Platform.OS === 'ios' ? is_zoomed? '105@ms0.3' :'95@ms0.3' : '85@ms0.3',
    flexDirection: 'row',
    alignItems: 'center',
  ...
  headerContainer2: {
    height: Platform.OS === 'ios' ? is_zoomed ? '115@ms0.3' :'105@ms0.3' : '85@ms0.3',
  },
  leftArrowIcon: {
    width: is_zoomed ? '40@ms0.3' : '24@ms0.3',
  ...
  centerImage: {
    height: is_zoomed ? '40@ms0.3' : '24@ms0.3',
    width: is_zoomed ? '230@ms0.3' : '134@ms0.3',
  },
  iconContainer: {
    width: '25%',
    height: '100%',
